$(document).ready(function(){
    ...
    if(event.which == 13){
      ...
      $.ajax({
        ...
        if (response.data.results.length!==0){
          ...
          var eventsUrl = "http://gateway.marvel.com:80/v1/public/characters/" + heroId + "/events?orderBy=-startDate" + "&limit=" + limit + "&ts=" + my_ts + "&apikey=" + pubKey + "&hash=" + my_hash;
  ...
  $('#myModal1').on('show.bs.modal', function (event) {
    ...
    var modal = $(this)
    var url = "http://gateway.marvel.com:80/v1/public/events/" + eventId + "?&ts=" + my_ts + "&apikey=" + pubKey + "&hash=" + my_hash;
    ...
    // var url = "http://gateway.marvel.com:80/v1/public/events/" + eventId + "/comics?issueNumber=1&ts=" + my_ts + "&apikey=" + pubKey + "&hash=" + my_hash;
    // $.ajax({
    //   url: url,
    //   type: "get",
    //   dataType: "json"
